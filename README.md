...
- [x] Explain what a token is used for.
      ...
      Tokes are strings of cryptic text that tells the clients-side server if the user is logged in. It's used to authenticate the user. 

- [x] What steps can you take in your web apps to keep your data secure?

      You can setup a private route that will keep users on public pages until they are authenticated to login.

- [x] Describe how web servers work.

      Computers are servers that are connected to the internet and via the world wide web. They locate a specific server computer through a URL and domain name, then retrieve information from that server.

- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

      C - Create: A Post request, a way to create data and add it to the database.
      R - Read: A Get request, a way to pull data from the database on a server. 
      U - Update: A Put request, a way to update date on the database.
      D - Delete: A Delete requested, pulled by a unique identifier and deleted form the database.
